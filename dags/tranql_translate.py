...
with DAG(
    ...
    continue_task_bulk_load = DummyOperator(task_id="continue to bulk create")
    continue_task_validate = DummyOperator(task_id="continue to validation")
    ...
    [create_bulk_load_nodes, create_bulk_load_edges] >> bulk_load >> continue_task_validate >>[validate, ] >> finish
